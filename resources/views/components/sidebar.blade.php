<nav class="navbar navbar-vertical navbar-expand-lg navbar-light">
    ...
    <div class="navbar-collapse">
        <ul class="navbar-nav mb-2" id="accordionExample" data-simplebar>
            ...
            <li class="nav-item">
                ...
                <div class="collapse-box collapse" id="sidebarUsers" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#transaction" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="transaction" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#member" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="member" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#visitors" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="visitors" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#adhoc" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="adhoc" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#attendance" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="attendance" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#churchCalender" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="churchCalender" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#churchWorker" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="churchWorker" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#cWorkerAccount" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="scWorkerAccount" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#debtor" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="debtor" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#daccount" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="daccount" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#department" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUsers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-people" viewBox="0 0 16 16">
                        <path
                ...
                <div class="collapse-box collapse" id="department" data-bs-parent="#accordionExample" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link">Dashboard</a>
                        </li>
